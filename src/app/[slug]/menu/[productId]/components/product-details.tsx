...
const ProductDetails = ({ product }: ProductDetailsProps) => {
    ...
    return (
        <>
            <div className="relative z-50 overflow-hidden flex flex-col flex-auto rounded-t-3xl p-5 mt-[1.5rem]">
                ...
                <Button className="rounded-full w-full mt-6" onClick={handleAddToCart}>Adicionar á socola</Button>
            </div>
            <CartSheet />
